...
from openea.modules.bootstrapping.alignment_finder import check_new_alignment as check_alignment_f1
import joblib
...
class AliNet(BasicModel):
    ...
    def eval_ref_sim_mat(self, csls=0):
        ...
        # embeds1 = tf.nn.l2_normalize(embeds1, 1)
        # embeds2 = tf.nn.l2_normalize(embeds2, 1)
        # mat_op = tf.matmul(embeds1, embeds2, transpose_b=True)
    ...
    def launch_alinet_training_k_repo(self, iter, iter_nums, steps, neighbors1, neighbors2):
