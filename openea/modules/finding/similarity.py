...
def sim_multi_blocks(embeds1, embeds2, blocks_num=1000):
    num = embeds1.shape[0]
...
if __name__ == '__main__':
    ...
    print(sim.shape)
    print("multi-block similarity calculation: " + str(time.time() - t))

    # sim = sim(a, b, metric='cosine', normalize=True)
    # print(sim.shape)
    # print("single-block similarity calculation: " + str(time.time() - t))
