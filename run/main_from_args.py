...
from openea.approaches import NMN
from openea.approaches import Cycle
...
if __name__ == '__main__':
    ...
    if args.embedding_module == "NMN" or "RDGCN" or "PARIS" or "RLEA" or "EMB_PARIS" or "Cycle" or "HIEA":
